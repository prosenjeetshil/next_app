...
class ActionProvider {
    ...
    callGenAI = async (prompt) => {
        const chatCompletion = await openAI.chat.completions.create({
            model: "gpt-3.5-turbo",
            messages: [
                {role:"system", content: "You are a personal diet and fitness advisor. Give short and precise answers with specific diet and exercise plan like what to eat from breakfast to dinner and what and when to exercise."},
